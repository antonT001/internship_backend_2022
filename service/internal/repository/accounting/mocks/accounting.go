...
func (_m *Accounting) List(input *models.AccountingListIn) ([]models.AccountingListFields, error) {
	ret := _m.Called(input)

	var r0 []models.AccountingListFields
	if rf, ok := ret.Get(0).(func(*models.AccountingListIn) []models.AccountingListFields); ok {
		r0 = rf(input)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.AccountingListFields)
		}
	}
